...
export_file = sprintf("%s%s%s%s%d", ARGV[5], "_" ,ARGV[6], "_" ,ARGV[8])
export_coordinates_file = sprintf("%s%s%s%s%s%d", ARGV[5], "_" ,ARGV[6], "_coordinates", "_" , ARGV[8])
...
replot sprintf("%s%s%s%s",data_dir,"vp_",export_coordinates_file,extention) @uv1 @pv title "virtual"
replot sprintf("%s%s%s%s",data_dir,"vp_",export_coordinates_file,extention) @uv2 @pv notitle
replot sprintf("%s%s%s%s",data_dir,"vp_",export_coordinates_file,extention) @uv3 @pv notitle
replot sprintf("%s%s%s%s",data_dir,"vp_",export_coordinates_file,extention) @uv4 @pv notitle
...
#     set view equal xyz
#     splot sprintf("%s%s%s",data_dir,export_file,extention) @u @p title ARGV[6]
#     replot sprintf("%s%s%s%s%s",data_dir,"vp_",export_file,"_coordinates",extention) @uv1 @pv title "virtual"
#     replot sprintf("%s%s%s%s%s",data_dir,"vp_",export_file,"_coordinates",extention) @uv2 @pv notitle
#     replot sprintf("%s%s%s%s%s",data_dir,"vp_",export_file,"_coordinates",extention) @uv3 @pv notitle
#     replot sprintf("%s%s%s%s%s",data_dir,"vp_",export_file,"_coordinates",extention) @uv4 @pv notitle
#     replot
# }
