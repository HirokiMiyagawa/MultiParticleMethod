...
export_file = sprintf("%s%s%s%s%d", ARGV[5], "_" ,ARGV[6], "_" ,ARGV[9])
data_dir = "visualize/plot_data/"
export_dir ="visualize/fig/"
export_normal_dir ="visualize/div_fig/"
extention = ".csv"
ex_extention = ".png"
...
set ticslevel 0             # Z軸をXY平面に一致させるs
...
set view equal xyz
splot sprintf("%s%s%s",data_dir,export_file,extention) @u @p title ARGV[6]
set output sprintf("%s%s%s",export_normal_dir,export_file,ex_extention)
replot
